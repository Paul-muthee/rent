...
<a href="add_payment.php.php"class="btn btn-primary btn-flat btn-pri" id="noPrint"> <i class="fa fa-money"></i> Add Payment</a>
...
<?php
                      ...
                      <tr>
                        ...
                        <td id="noPrint"><a href="delete_payment.php?id=<?php echo $row["id"]; ?>"class="btn btn-flat btn-pri btn-danger"> <i class="fa fa-trash"></i> Delete </a> </td>
                      </tr>
                       <?php $count++;
                    } ?>
                </tr>
