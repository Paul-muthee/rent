        ...
        <!-- /inner_content-->
                <div class="inner_content">
                    ...
                    <div class="inner_content_w3_agile_info two_in">
                      <h2 class="w3_inner_tittle">Record New Rent</h2>
...
<div class="forms-inner">
    ...
    <div class="wthree_general graph-form agile_info_shadow ">
            <h3 class="w3_inner_tittle two">Rent Details </h3>
...
<form class="form-horizontal" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="POST">
    ...
    <div class="form-group">
        <label for="focusedinput" class="col-sm-2 control-label">Amount Due</label>
        <div class="col-sm-8">
...
if (isset($_POST["period"])) {
    ...
    $query = "INSERT INTO rents (amount_due,tenant,period,date,added_by,cleared)

    VALUES ('{$amount}','{$id_no}','{$period}','{$reg_date}','{$user}','{$cleared}')";
