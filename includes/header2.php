...
<html lang="zxx">
	<head>
		<title id="noPrint">Kibera Law Courts</title>
		<!-- custom-theme -->
...
<body>		 
   <div class="w3_agileits_top_nav" id="noPrint">
			<ul id="gn-menu" class="gn-menu-main">
				...
				<!-- //nav_agile_w3l -->
                <li class="second logo"><h1><a href="index.php"><i class="fa fa-graduation-cap" aria-hidden="true"></i> Kibera Law Courts </a></h1></li>
				       ...
				       <ul class="top_dp_agile">
									<li class="dropdown profile_details_drop">
										...
										<ul class="dropdown-menu drp-mnu">
											<li> <a href="#"><i class="fa fa-user"></i> <?php echo $_SESSION['national_id']; ?></a> </li>
